          ...
          <div className=' py-3 border  border-black/10 rounded-lg mb-20 bg-gray-100 w-full'>
            ...
            <div className='flex flex-col items-center  border-b border-gray-600/10 px-3 py-3'>
              ...
              <div className={`flex mt-3 ${arrowfirst ? "" : "hidden "} justify-center items-center transform transition-all duration-200 space-x-2 p-3 md:w-3/4 border border-gray-600/10 rounded-xl`}>
                <h5 className={`${Type == "all" ? "border-black border-1 text-xs md:text-md px-4 py-2  rounded-md" : "text-xs md:text-md px-4 py-2 flex flex-col items-center justify-center gap-2  text-nowrap rounded-md"}`} onClick={() => Settypehome("all")}> <img src='../../public/images/residential.png' className='w-12 h-12' />  Any Type</h5>
                <h5 className={`${Type == "room" ? "border-black border-1 text-xs md:text-md px-4 py-2  rounded-md" : "text-xs md:text-md px-4 py-2  flex flex-col gap-2 rounded-md"}`} onClick={() => Settypehome("room")}><img src='../../public/interior-design.png' className='w-14 h-14' />Room</h5>
                <h5 className={`${Type == "flat" ? "border-black border-1 text-xs md:text-md px-4 py-2  rounded-md" : "text-xs md:text-md px-4 py-2  flex flex-col gap-2 rounded-md"}`} onClick={() => Settypehome("flat")}><img src='../../public/images/flats.png' className='w-14 h-14' /> flat</h5>
                <h5 className={`${Type == "house" ? "border-black border-1 text-xs md:text-md px-4 py-2  rounded-md" : "text-xs md:text-md px-4 py-2  rounded-md flex flex-col gap-2"}`} onClick={() => Settypehome("house")}><img src='../../public//house.png' className='w-14 h-14' /> house</h5>
              </div>
